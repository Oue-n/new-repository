...
class SeerBehavior(object):
    ...
    def talk(self):
        ...
        #     if self.myrole in "SEER":  # and self.stealth == False:
        ...
        #             if True:  # random.random() > 0.5 or self.myrole == "SEER":
        ...
        #         # CO要求
        #         if self.talk_turn == 1:
        #             return self.gen.generate("d1t1")
        #         # CO確認
        #         if self.talk_turn == 2:
        #             if len(self.seers) == 2 and random.random() < 0.8:
        #                 self.q.append(self.gen.generate(
        #                     "CO=2", list(self.seers)))
        #             if len(self.seers) < 3:
        #                 self.q.append(self.gen.generate("CO<3"))
        #             if len(self.seers) == 3:
        #                 self.q.append(self.gen.generate("CO=3"))
        #             if len(self.seers) > 3:
        #                 self.q.append(self.gen.generate("CO>3"))
